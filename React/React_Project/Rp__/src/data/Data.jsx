const data = [
  ...
  "price": 5,
  "description": "Ergonomically angled to fit perfectly in your ear canal that provides long lasting comfort for every day usage. Features 1.25 meter long cable & L-shaped 3.5mm jack to connect with your phone. Due to the L-shape, the connector will deliver a strong & durable life. Earphones are compatible with Android, iOS & Windows devices with jack. Powerful 10 mm drivers & aluminum sound chamber for super extra bass and clear sound for the best music & calling experience. High-quality silicone earbuds, which are gentle on skin without compromising the comfortable fit on the ears. In-line microphone with a durable multi-function button to play/pause your music, and answer/end your calls, all with just one tap.",
  "brand": "xiaomi",
  ...
  "price": 12,
  "description": "Rockerz 370 come equipped with latest Bluetooth v5.0 for instant wireless connectivity The powerful 300mAh battery provides up to 8 Hours of audio bliss 40mm Dynamic Drivers supply immersive High Definition sound The headset has padded earcups for a comfortable experience The headphone has been ergonomically and aesthetically designed for a seamless experience One can connect to Rockerz 370 via dual modes for connectivity in the form of Bluetooth and AUX 1 year warranty from the date of purchase.",
  "brand": "boat",
  "model": "Rockerz 370",
  "color": "Black",
  "category": "audio"
  ...
  "price": 132,
  "description": "2MP+5MP dual camera | 20MP front facing camera 15.69 centimeters (6.18-inch) IPS (in-cell) multi-touch capacitive touchscreen with 2246 x 1080 pixels resolution, 403 ppi pixel density Memory, Storage & SIM: 6GB RAM, 64GB internal memory expandable up to 128GB | Dual SIM (nano+nano) dual-standby (4G+4G) Andriod Oreo v8.1 operating system with 2.8GHz Qualcomm Snapdragon 845 octa core processor, 8xKyro cores/10 nm architecture 4000mAH lithium-ion battery with quick charge 3.0 to keep you going all-day long 1 year manufacturer warranty for device and 6 months manufacturer warranty for in-box accessories including batteries from the date of purchase",
  "brand": "xiaomi",
  "model": "Poco F1",
  "color": "steel blue",
  "category": "mobile",
  ...
  "price": 1546,
  "description": "15.54 cm (6.1-inch) Super Retina XDR display featuring Always-On and ProMotion Dynamic Island, a magical new way to interact with iPhone 48MP Main camera for up to 4x greater resolution Cinematic mode now in 4K Dolby Vision up to 30 fps Action mode for smooth, steady, handheld videos All-day battery life and up to 23 hours of video playback Vital safety technology — Crash Detection calls for help when you can’t",
  "brand": "apple",
  "model": "iPhone 14 Pro",
  "color": "Golden",
  "category": "mobile"
  ...
  "price": 507,
  "description": "The 5G enabled flagship Snapdragon 888 chipset is designed on a 5nm fab process and is paired with LPDDR5 RAM and UFS 3.1 storage to ensure ultra-smooth performance and seamless multitasking experience. The 6.67",
  "brand": "xiaomi",
  "model": "11T Pro",
  ...
  "price": 54,
  "description": "Renowned Sennheiser sound quality for a unique listening experience Built-in microphone and remote for call and music control Closed-back around-ear headphones reduce unwanted background noise for your comfort Lightweight, foldable headphones for easy on-the-go storage Impedance: 18 Ω ; Frequency response (Microphone): 100 – 10,000 Hz (-10 dB) ; Frequency response (Headphones): 18–20,000 Hz (-10 dB) ; Jack plug: 3.5mm",
  "brand": "Sennheiser",
  "model": "HD 400s",
  "color": "Black",
  "category": "audio",
  ...
  "price": 14,
  "description": "Compatibility – PC / Laptop Computer(Windows 10/8/7/XP), Steam, Play Station 3(PS3), Android Mobile Phone*/Tablet*/the device needs support OTG function( * not all Android phones are supported, check your device before purchasing for Android devices, Limited games can play on it which are supported to android games) Excellent Design – Equipped with 2.4Ghz wireless technology, supports up to 10m range | Wear-resistant Anti-slip Joystick | Cool Appearance | Comfortable Grip Plug & Play -Only for PC games supporting X input mode, Android mobile games supporting Android mode, Play Station 3. No need to install drivers except for Windows XP Feature - Multi-mode : X input, D input, Android, PS3 | Vibration Feedback Function",
  "brand": "ant esports",
  "model": "GP310",
  "color": "black",
  "category": "gaming",
  ...
  "price": 163,
  "description": "🎮900+ Selected Classic Games: This X12 game console has nostalgic 900 games, unique game file and folder list systematically, find the game you want to play by accurate original English name and number more quickly. 🎮Customized Professional System: Exclusive customization console system, English default setted and Save & Load features, no more lost datas and start again, providing excellent gaming experience. 🎮Quick to Go: The handheld game console with super compact size, easy to carry wherever you go on a business trip, traveling, camping, also equip with bigger battery for long playing. 🎮Multimedia Gaming Device: With multifunction designing, you can reach more entertainment function like playing game, watching movie, music, TXT fiction etc. 🎮Perfect Gifts for Kids & Nostalgia: This mini gaming player is a perfect companion to keep your children occupied and improve their hand-eye coordination.",
  "brand": "CredevZone",
  "model": "X12 Red&blue",
  "category": "gaming",
  "discount": 9
  ...
  "price": 42,
  "description": "Waterproof and dustproof with an IP67 rating, this speaker is just as good outside as it is inside. Get up to 16 hours of battery life to keep the party going. Need to make a call? No problem. Whether you’re at home or out and about, the built-in mic lets you enjoy hands-free calling straight through your speaker. In one tap, the Sony SRS-XB13 enables quick effortless Bluetooth pairing with you Android devices. A passive radiator works together with a full-range speaker to enhance low-end tones, giving bass a boost.",
  "brand": "sony",
  "model": "SRS-XB13",
  "color": "black",
  "category": "audio",
  ...
  "price": 289,
  "description": "ULTRA-LOW BASS RESPONSE Enjoy powerful deep bass, without compromising the depth and balance of the track WIRELESS PERFORMANCE Reliable Bluetooth connectivity with built-in microphone 50 HOURS PLAYBACK On a full four-hour charge, plus quick 15min charge for 3 hours playback DUO POWER DRIVERS Two 40 mm Neodymium driver units provide deep, yet delicate bass sound HIGH-COMFORT FIT Soft cushioned headband and earpads fit gently over the ears for hours of anytime anywhere comfort",
  "brand": "panasonic",
  ...
  {
  "id": 33,
  "title": "boAt Stone 180 5W Bluetooth Speaker with Upto 10 Hours Playback, 1.75",
  "image": "https://storage.googleapis.com/fir-auth-1c3bc.appspot.com/1692943845065-71vI6nfLtYL._SL1500_.jpg",
  "price": 13,
  "description": "Stone 180 comes equipped with 1.75" ,
  "brand": "boat",
  "model": "Stone 180",
  "color": "black",
  "category": "audio",
  ...
  "price": 12,
  "description": "Made in India : From design to manufacturing, Mivi DuoPods A25 is proudly made in India. It is built locally to compete globally..Note : If the size of the earbud tips does not match the size of your ear canals or the headset is not worn properly in your ears, you may not obtain the correct sound qualities or call performance. Change the earbud tips to ones that fit more snugly in your ears Concert In Your Ears: Need to get away from the ever noisy city life? Simply tune in to the Mivi DuoPods A25 and immerse yourself in the high-quality sound of these wireless earbuds. Studio Quality Sound: The Mivi DuoPods A25 has a studio quality sound output which makes it one of the best wireless earbuds in the market or anything youve ever tried. ",
  "brand": "Mivi",
  "model": "Duopods A25",
  "color": "white",
  "category": "audio",
  ...
  "price": 266,
  "description": "Loud just got smaller. Uxbridge Voice is engineered to create a thunderous sound from itscompact frame. An advanced setup with high-end components come together to producescreaming highs Consider this speaker your backstage pass to every song on the planet. Access to the world’s music has never been easier, just ask Alexa to play music.Frequency Range 54-20,000 Hz Fill your home with immersive sound by building a multi-room system with Amazon Echo andother supported Alexa built-in speakers or Airplay 2 enabled speakers. You can play music, get answers, manage everyday tasks and easily control smart devicesaround your home – just by using your voice. Alexa can help you listen to your favouritesong, turn up the volume,",
  "brand": "Marshall",
  ...
  "price": 63,
  "description": "JBL PURE BASS SOUND: The JBL Tune 720BT utilizes the renowned JBL Pure Bass sound, the same technology that powers the most famous venues all around the world. UP TO 76H BATTERY LIFE: Get the most out of your entertainment with up to 76 hours of wireless listening pleasure, and easily recharge the battery in as little as 2 hours using the convenient Type-C USB cable. QUICK CHARGE: Running low on battery? With a quick 5-minute recharge, you can get an additional 3 hours of music playback to keep the beats going JBL HEADPHONES APP: By downloading the JBL Headphones app, you can personalize the sound of your Tune 720BT headphones according to your preferences with ease, using the EQ settings. Moreover, the app offers voice prompts in your desired language to guide you through the different headphone features",
  "brand": "jbl",
  "model": "Tune 720BT",
  "color": "Blue",
  "category": "audio",
  ...
  "price": 629,
  "description": "Experience powerful, booming sound with the SW5 wireless subwoofer for use with HT-A9 & A7000 soundbars. Deep bass and further clearness and fidelity Wireless connectivity and quick and easy setup Add depth with 300W powerful bass",
  "brand": "sony",
  "model": "SA-SW5",
  "color": "black",
  "category": "audio",
  ...
  "price": 919,
  "description": "DENON HOME 350 The Denon Home series fills your home with superb wireless sound. The powerful Denon Home 350 with its amazing sound stage takes your music into every corner, even in large rooms. Pair it with another Denon Home 350 for stereo or combine it with other HEOS Built-in products. UPGRADE TO SUPERB WIRELESS SOUND Enjoy exceptional sound with the Denon Home Series. Stream your favourite music effortlessly and make use of quick pre-selections with just a gentle touch. Experience impressive acoustic performance, based on 110 years of sound innovation. A MIGHTY PERFORMER. Like every Denon the Denon Home 350 is built to deliver best-in-class audio quality. With advanced acoustic hardware, expertly tuned digital signal processing and premium drivers, the Denon Home 350 delivers the clearest highs and deepest lows. Experience excellence in every beat.",
  "brand": "Denon",
  ...
  "price": 24,
  "description": "JBL DEEP BASS SOUND: Feel the sound with the Deep Bass powered by the 8mm Dynamic drivers and add fun to your routine. UPTO 20 HOURS OF PLAYTIME: With 5 hours in the earbuds and 15 hours in the case, the JBL Wave 200TWS don’t drop until you do. QUICK CHARGE: Running Low on Charge, worry not. A quick 15min of charge provides you with playtime upto an Hour. DUAL CONNECT TECHNOLOGY: With the Dual Connect Technology on the Wave 200 TWS, take calls or listen to music with either bud (or both). Choose which one to use and leave the other one in the case to save battery life.",
  "brand": "jbl",
  "model": "JBL",
  "color": "Black",
  "category": "audio"
  ...
  "price": 108,
  "description": "Lightest Earbuds : Focus on your music for as long as you like. These small, lightweight earbuds have an ergonomic surface design for all-day comfort, even for smaller ears. Noise Cancellation: Cancel out background noise with Noise Sensor Technology or use the Ambient Sound Mode to stay connected to your natural surroundings. Headphones Connect app to control your listening experience. Multipoint connection: For total convenience, these Bluetooth headphones can be paired with two Bluetooth devices at the same time. So when call comes in your headphones know which device is ringing and connects to the right one automatically. Listen all day, charge in minutes: Enjoy up to 15 hours of listening thanks to the handy charging case.",
  "brand": "sony",
  "model": "WF-C700N",
  "color": "black",
  "category": "audio",
  ...
  "price": 384,
  "description": "Resolution: 4K Ultra HD (3840 x 2160) | Refresh Rate: 60 hertz | 178° wide viewing angle Connectivity: Dual Band Wi-Fi (2.4 GHz/ 5 GHz) | 3 HDMI ports to connect latest gaming consoles, set top box, Blu-ray Players | 2 USB ports to connect hard drives and other USB devices | ALLM | eARC | Bluetooth 5.0 | Optical | Ethernet | 3.5mm earphone Jack Sound: 30 Watts Output | Dolby Audio, DTS Virtual: X, DTS-HD Smart TV Features : Android TV 10 | PatchWall 4 with IMDb integration | Kids Mode with Parental Lock | 300+ Free Live Channels | Universal search | Language Universe (16+ Languages) | India's Top 10 | Miracast | Supported Apps: Prime Video | Netflix | Disney + Hotstar | YouTube | Apple TV | 10000+ apps from Play Store | Quad core A55 CPU processor | Chromecast built-in | Ok Google | Auto Low Latency Mode | 2GB RAM + 8GB Storage Display: 4K HDR | Metal Bezel-less Design | Dolby Vision | HDR10 | HLG | Reality Flow MEMC | Vivid Picture Engine | DCI-P3 94% Colour Gam",
  "brand": "mi",
  "model": "Xiaomi TV X50",
  "color": "black",
  "category": "tv",
  ...
  "price": 444,
  "description": "Resolution: QLED, 4K Ultra HD (3840x2160) | Refresh Rate: 60 Hertz | 178 Degree wide viewing angle Connectivity: Dual band Wifi | 2 way Bluetooth | HDMI ports 2.1 x 3 (HDMI 1 supports eARC) to connect personal computer, laptop, set top box, Blu-ray speakers or a gaming console | USB ports 2.0 x 1, 3.0 x 1 to connect hard drives or other USB device Sound: 30 Watts Output | High Fidelity Speakers with Dolby Atmos | 5 Sound Modes - Stadium, Standard, Movie, Music, Speech Smart TV Features: Google TV | Content Recommendations | Watchlist | Personal Profile | Kids Profile | Google Assistant | Built-in Chromecast | Voice enabled Smart Remote | Hotkeys for Quick Access - Netflix, Prime Video, YouTube, Disney+Hotstar | Quad Core Processor 2GB RAM | 16GB Storage",
  "brand": "acer",
  "model": "AR50GR2851VQD",
  "color": "black",
  "category": "tv",
  ...
  "price": 1322,
  "description": "Display backlight technology used by the TV The number of display pixels in the TV, usually denoted by the number of horizontal pixels multiplies by number of vertical pixels ",
  "brand": "LG",
  "model": "OLED55BXPTA",
